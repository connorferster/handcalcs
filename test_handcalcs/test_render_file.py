...
def test_parse_line_args():
    assert handcalcs.render.parse_line_args("params 5") == {"override": "params", "precision": 5}
    assert handcalcs.render.parse_line_args("symbolic") == {"override": "symbolic", "precision": ""}
    assert handcalcs.render.parse_line_args("short long 3") == {"override": "long", "precision": 3}
    assert handcalcs.render.parse_line_args("symbolical, 1") == {"override": "", "precision": 1}